...
// Subscription events
class LoadAccountSubscriptions extends AccountsEvent {
  final String accountId;
...
class RefreshAccountSubscriptions extends AccountsEvent {
  final String accountId;
...
// Invoice events
class LoadAccountInvoices extends AccountsEvent {
  final String accountId;
...
class RefreshAccountInvoices extends AccountsEvent {
  final String accountId;
