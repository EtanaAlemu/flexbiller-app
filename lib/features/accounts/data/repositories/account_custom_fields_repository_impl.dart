...
class AccountCustomFieldsRepositoryImpl
  ...
  Future<List<AccountCustomField>> getAccountCustomFields(
    ...
    try {
      final customFieldsModels = await _remoteDataSource.getAccountCustomFields(
        accountId,
      );
  ...
  Future<AccountCustomField> getCustomField(
    ...
    try {
      final customFieldModel = await _remoteDataSource.getCustomField(
        accountId,
        customFieldId,
      );
  ...
  Future<List<AccountCustomField>> createMultipleCustomFields(
    ...
    try {
      final customFieldsModels = await _remoteDataSource
  ...
  Future<List<AccountCustomField>> getCustomFieldsByValue(
    ...
    try {
      ...
      return allCustomFields
          .where(
            (field) => field.value.toLowerCase().contains(value.toLowerCase()),
          )
          .toList();
    } catch (e) {
      rethrow;
