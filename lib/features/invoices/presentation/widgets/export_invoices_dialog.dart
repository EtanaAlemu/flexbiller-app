...
class ExportInvoicesDialog extends StatefulWidget {
  final List<Invoice> invoices;

  const ExportInvoicesDialog({Key? key, required this.invoices})
    : super(key: key);

  @override
  State<ExportInvoicesDialog> createState() => _ExportInvoicesDialogState();
}

class _ExportInvoicesDialogState extends State<ExportInvoicesDialog> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Export ${widget.invoices.length} selected invoice(s)',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '• ${widget.invoices.length} invoice(s) will be exported',
