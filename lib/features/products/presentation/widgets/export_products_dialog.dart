...
class ExportProductsDialog extends StatefulWidget {
  ...
  @override
  State<ExportProductsDialog> createState() => _ExportProductsDialogState();
}

class _ExportProductsDialogState extends State<ExportProductsDialog> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${widget.products.length} products ready to export',
