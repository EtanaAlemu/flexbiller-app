...
part 'block_subscription_request_model.g.dart';

@JsonSerializable()
class BlockSubscriptionRequestModel {
  ...
  const BlockSubscriptionRequestModel({
  ...
  factory BlockSubscriptionRequestModel.fromJson(Map<String, dynamic> json) =>
      _$BlockSubscriptionRequestModelFromJson(json);

  Map<String, dynamic> toJson() => _$BlockSubscriptionRequestModelToJson(this);
}
