...
class _SubscriptionCustomFieldsDemoPageState
  ...
  final TextEditingController _customFieldNameController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Subscription Custom Fields Demo')),
        body: Padding(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildFeatureItem('• Add custom fields to subscriptions'),
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Add Custom Fields'),
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Get Custom Fields'),
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 16),
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Update Custom Fields'),
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 16),
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Remove Custom Fields'),
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 16),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        _buildApiEndpoint('POST', '/api/subscriptions/{id}/customFields', 'Add custom fields'),
                        _buildApiEndpoint('GET', '/api/subscriptions/{id}/customFields', 'Get custom fields'),
                        _buildApiEndpoint('PUT', '/api/subscriptions/{id}/customFields', 'Update custom fields'),
                        _buildApiEndpoint('DELETE', '/api/subscriptions/{id}/customFields', 'Remove custom fields'),
                      ],
                    ),
                  ),
                ],
  ...
  void _addCustomFields() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<SubscriptionsBloc>().add(AddSubscriptionCustomFields(
  ...
  void _getCustomFields() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<SubscriptionsBloc>().add(GetSubscriptionCustomFields(subscriptionId));
  ...
  void _updateCustomFields() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<SubscriptionsBloc>().add(UpdateSubscriptionCustomFields(
        subscriptionId: subscriptionId,
        customFields: customFields,
      ));
  ...
  void _removeCustomFields() {
    if (_formKey.currentState!.validate()) {
      final subscriptionId = _subscriptionIdController.text.trim();
      final customFieldIds = 'a1571a46-29f9-4514-8a8d-894e1ffd8dfc'; // Sample ID

      context.read<SubscriptionsBloc>().add(RemoveSubscriptionCustomFields(
        subscriptionId: subscriptionId,
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text('Removed Fields: ${state.result['removedCustomFields'].join(', ')}'),
                ],
              ),
              actions: [
                TextButton(
  ...
  Widget _buildCustomFieldsList(List<SubscriptionCustomField> customFields) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        ...customFields.map((field) => Container(
          margin: const EdgeInsets.only(bottom: 8),
          padding: const EdgeInsets.all(8),
          decoration: BoxDecoration(
            color: Colors.grey.shade100,
          ...
          child: Column(
            ...
            children: [
              if (field.customFieldId != null)
                Text('ID: ${field.customFieldId}', style: const TextStyle(fontSize: 12)),
              Text('Name: ${field.name}', style: const TextStyle(fontWeight: FontWeight.bold)),
              Text('Value: ${field.value}'),
              if (field.objectType != null)
                Text('Type: ${field.objectType}', style: const TextStyle(fontSize: 12)),
            ],
          ),
        )),
      ],
