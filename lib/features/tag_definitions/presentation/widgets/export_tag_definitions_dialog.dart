...
class ExportTagDefinitionsDialog extends StatefulWidget {
  final List<TagDefinition> selectedTagDefinitions;

  const ExportTagDefinitionsDialog({
    super.key,
    required this.selectedTagDefinitions,
  });

  @override
  State<ExportTagDefinitionsDialog> createState() =>
      _ExportTagDefinitionsDialogState();
}

class _ExportTagDefinitionsDialogState
    extends State<ExportTagDefinitionsDialog> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${widget.selectedTagDefinitions.length} tag definitions ready to export',
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSummaryItem(
            ...
            colorScheme,
            Icons.label_rounded,
            '${widget.selectedTagDefinitions.length} tag definitions',
            'will be exported',
          ),
