...
class ExportPaymentsDialog extends StatefulWidget {
  final List<Payment> payments;

  const ExportPaymentsDialog({Key? key, required this.payments})
    : super(key: key);

  @override
  State<ExportPaymentsDialog> createState() => _ExportPaymentsDialogState();
}

class _ExportPaymentsDialogState extends State<ExportPaymentsDialog> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Export ${widget.payments.length} selected payment(s)',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '• ${widget.payments.length} payment(s) will be exported',
