...
class ExportPlansDialog extends StatefulWidget {
  final List<Plan> plans;

  const ExportPlansDialog({Key? key, required this.plans}) : super(key: key);

  @override
  State<ExportPlansDialog> createState() => _ExportPlansDialogState();
}

class _ExportPlansDialogState extends State<ExportPlansDialog> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${widget.plans.length} plans ready to export',
